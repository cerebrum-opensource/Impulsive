...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   ...
   <div class="review-content-section">
      <div class="input-group mg-b-pro-edt">
         <div class="form-group">
            ...
            <input type="text" name="{{ $field->id }}" placeholder="{{ $field->place_holder }}" class="form-control" value="{{@$fieldValues[$field->id]}}">
         </div>
      </div>
   </div>
   @endif
      ...
      <div class="input-group mg-b-pro-edt">
         ...
         <div class="form-group">
           ...
           <select name="{{ $field->id }}" class=" pro-edt-select form-control-primary form-control">
            ...
            if(@$fieldValues[$field->id] && @$fieldValues[$field->id]== $option)
              echo 'selected';
   ...
   <div class="review-content-section">
      <div class="input-group mg-b-pro-edt">
         <div class="form-group">
             <label >{{ $field->name }} </label>
            <input type="text" name="{{ $field->id }}" placeholder="{{ $field->place_holder }}" class="form-control datePicker" value="{{@$fieldValues[$field->id]}}">
         </div>
      </div>
   </div>
   @endif
   ...
   <div class="review-content-section">
      <div class="input-group mg-b-pro-edt">
         ...
         <label >{{ $field->name }} </label>
         <div class="radio">
           <label><input type="radio" name="{{ $field->id }}" placeholder="" value="yes"
            @php
            if(@$fieldValues[$field->id] && @$fieldValues[$field->id]=='yes')
              echo 'checked';
            @endphp
            class=""> {{ trans('label.yes') }}</label>
         </div>
         <div class="radio">
           <label><input type="radio" name="{{ $field->id }}" placeholder=""  @php
            if(@$fieldValues[$field->id] && @$fieldValues[$field->id]=='no')
              echo 'checked';
            @endphp value="no" class="">{{ trans('label.no') }}</label>
         </div>
   ...
   <div class="review-content-section">
      <div class="input-group mg-b-pro-edt">
         ...
         <label >{{ $field->name }} </label>
         <div class="radio">
           <label><input type="radio" name="{{ $field->id }}"  @php
            if(@$fieldValues[$field->id] && @$fieldValues[$field->id]=='yes')
              echo 'checked';
            @endphp placeholder="" value="yes" class="">{{ trans('label.yes') }}</label>
         </div>
         <div class="radio">
           <label><input type="radio" name="{{ $field->id }}"  @php
            if(@$fieldValues[$field->id] && @$fieldValues[$field->id]=='no')
              echo 'checked';
            @endphp placeholder="" value="no" class="">{{ trans('label.no') }}</label>
         </div>
      ...
      <div class="row">
         <div class="col-sm-2">
            <nav class="nav-sidebar">
               <ul class="nav">
                  @foreach($editFields as $unassignedField)
