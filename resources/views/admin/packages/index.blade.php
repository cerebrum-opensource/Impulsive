        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    <h4>{{ trans('label.package_list') }}</h4>
                    <div class="add-product">
                        <a href="{{ route('add_package') }}">{{ trans('label.add_package') }}</a>
                    </div>
...
jQuery(document).ready(function() {
    ...
    $('.datatable').DataTable({
        ...
        serverSide: true,
        bSort: false,
        ajax: "{{ route('datatable/getPackages') }}",
        language: {
...
function package_delete(package_id){
