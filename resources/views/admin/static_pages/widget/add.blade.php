                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> {{ trans('label.widget') }} </a></li>
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                   <div class="input-group mg-b-pro-edt">
                                    ...
                                    <div class="input-group mg-b-pro-edt">
                                     ...
                                     <div class="input-group mg-b-pro-edt">
                                       {{ Form::label('header4', trans('label.header_link')) }}
                                      {!! Form::textarea('header4',null,['class'=>'form-control', 'rows' => 2, 'cols' => 40,'placeholder' =>trans('label.header_link')]) !!}
                                        <span class="error" style="color:red"></span>
                                     </div>
                               </div>
                             </div>
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <div class="text-center custom-pro-edt-ds">
                                        ...
                                        <input type='hidden' name='widget_id' value='{{ $widget->id ? $widget->id : 0 }}' >
                                         ...
                                         <button type="button" onClick="javascript:disCardForm('{{ route('widgets') }}')" class="btn blue-btn btn-ctl-bt waves-effect waves-light">{{ trans('label.discard') }}
                                        </button>
                                     </div>
                                  </div>
                               </div>
...
function saveform(formId){
  ...
  $.ajax({
    ...
    success:function(data){
        ...
        window.location.href="{{ route('widgets') }}";   
    },
