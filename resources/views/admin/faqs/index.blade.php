        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap loader_div">
                    <h4>{{ trans('label.faqs') }}</h4>
                    <div class="add-product">
                        <a href="{{ route('add_faq') }}">{{ trans('label.add_faq') }}</a>
                    </div>
...
function faq_delete(faq_id){
    ...
    var confrm = confirm("{{ trans('message.are_you_sure_delete_faq') }}");
    console.log(confrm);
    if(confrm == true)
    {
        $.ajax({
