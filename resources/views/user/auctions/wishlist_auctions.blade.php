@if(count($wishList))
@foreach($wishList as $recallAuction)
  @php
...
<li>
   <span class="img-upper">
      ...
      @endif
      {!! $recallAuction->auction->status_badge !!}
   ...
   <span class="text1a text2a">{{ trans('label.regular_price') }}: {{ $product->product_price }} {{ CURRENCY_ICON }},-</span>
   </span>
</li>
@endforeach
@else
