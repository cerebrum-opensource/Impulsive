...
@php
  $name = trans('label.support_widget');
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap loader_div">
                    <h4>{{ trans('label.support_widget') }}</h4>
                    @if($count < 3)
                    <div class="add-product">
                        <a href="{{ route('add_support_widget') }}">{{ trans('label.add_widget') }}</a>
                    </div>
                    @endif
...
jQuery(document).ready(function() {
    ...
    $('.datatable').DataTable({
        ...
        serverSide: true,
        bSort: false,
        ajax: "{{ url('admin/supportWidgetList') }}",
        columns: [
