    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
             ...
             'min'=> 'Passwort eingeben zwischen 8 bis 16 Zeichen.',
             'max'=> 'Passwort eingeben zwischen 8 bis 16 Zeichen.',
             'regex'=> 'Das Passwort sollte einen Großbuchstaben, Kleinbuchstaben, eine Zahl und ein Sonderzeichen enthalten aus ! $ # % @',
        ],
        'dob' => [
        ...
        'final_countdown' => [
             'required' => 'Final countdown sollte nicht leer sein',
             'integer' => "Final countdown sollten nur Zahlen sein.",
             'min' => "Final countdown sollte zwischen 1 bis 60.",
             'max' => "Final countdown sollte zwischen 1 bis 60.",
        ],
        'start_time' => [
        ...
        'bid' => [
             'required' => 'Gebote sollten nicht leer sein',
             'integer' => "Gebote müssen Zahlen sein.",
             'min' => "Gebot soll größer wie 1 sein.",
        ],
        'description' => [
             'required' => 'Die Beschreiben darf nicht leer sein.'
        ],
        'image' => [
