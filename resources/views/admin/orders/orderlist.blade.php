            ...
            <div class="product-status-wrap">
               ...
               <div style="margin-bottom: 15px">
                  <form method="POST" id="order-search-form" class="form-inline" role="form">
                     ...
                     <button style="float: right;"href="#" class="btn btn-primary basic-btn export_record" ><b> {{trans('label.export')}} </b></button>
    ...
    $('body').on('click', '.export_record', function(e) {
       ...
       {   
          ...
          // var ids =  $('.checkbox:checked').map(function(){return $(this).val();}).get();
           ...
           var url = "{{ route('admin_deactiveAuction_export') }}?" + $.param(query)
           window.location = url;
