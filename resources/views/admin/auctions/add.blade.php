                  ...
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="review-content-section">
                           ...
                           <div class="input-group mg-b-pro-edt">
                              {{ Form::label('live_auction', trans('label.live_auction')) }}
                              {{ Form::checkbox('live_auction',null,null, array('id'=>'live_auction')) }}
                              <span class="error" style="color:red"></span>
                           </div>
                           <div class="input-group mg-b-pro-edt datetimepicker_div">
                              {{ Form::label('start_time', trans('label.start_date_time')) }}
                              {{ Form::text('start_time', null, array('class' => 'form-control datetimepicker','placeholder' =>trans('label.start_date_time'))) }}
                              <span class="error" style="color:red"></span>
                           </div>
                           <div class="input-group mg-b-pro-edt">
