                ...
                <div class="product-status-wrap">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button><button title="Delete" class="pd-setting-ed"><i class="fa fa-remove " aria-hidden="true"></i></button></td>
                        </tr>
                        <tr>
                            <td>2</td>
                        ...
                        <tr>
                            <td>4</td>
                            <td>Category Title 4</td>
                            <td><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button><button title="Delete" class="pd-setting-ed"><i class="fa fa-remove " aria-hidden="true"></i></button></td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Category Title 5</td>
                            <td><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button><button title="Delete" class="pd-setting-ed"><i class="fa fa-remove " aria-hidden="true"></i></button></td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>Category Title 6</td>
                            <td><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button><button title="Delete" class="pd-setting-ed"><i class="fa fa-remove " aria-hidden="true"></i></button></td>
                        </tr>
                    </table>
